...
class AppSettingsUI(QWidget):
    ...
    def setup_ui(self):
        ...
        self.lbl_choose_font = QLabel()
        self.lbl_choose_font.setFont(self.default_font)
        self.lbl_choose_font.setText('Выбор шрифта')
        self.lbl_choose_font.setAlignment(Qt.AlignmentFlag.AlignLeft)
        self.lbl_choose_font.setFixedHeight(30)
        self.lbl_choose_font.setObjectName('AS-OptionLabel')

        self.items_choose_font = QFontDatabase.families()
        self.cb_choose_font = QComboBox()
        self.cb_choose_font.setFont(self.default_font)
        self.cb_choose_font.addItems(self.items_choose_font)
        self.cb_choose_font.setCurrentIndex(self.items_choose_font.index(
            self.cfg_handler.get('app')['font_family']))
        self.cb_choose_font.setFixedHeight(30)
        self.cb_choose_font.setMinimumWidth(100)
        self.cb_choose_font.setObjectName('cb_choose_theme')
        self.cb_choose_font.currentTextChanged.connect(self.change_font_family)

        # --- горизонтальный layout для выбора шрифта ---
        self.choose_font_hlayout = CustomHBoxLayout(spacing=5)
        
        # --- горизонтальный layout для выбора шрифта: зависимости ---
        self.choose_font_hlayout.add([
            (self.lbl_choose_font, None), 
            (self.cb_choose_font, Qt.AlignmentFlag.AlignRight)])
        ...
        self.general_area_vlayout.add([
            ...
            (Separator(), None), self.choose_font_hlayout, 
            (Separator(), None)])
    ...
    def change_font_family(self):
        font_family = self.cb_choose_font.currentText()
        self.cfg_handler.set('app', {'font_family': font_family})

        self.launcher.font_family = self.cfg_handler.get('app')['font_family']
